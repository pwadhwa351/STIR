         ...
         ++bin.axial_pos_num())
      {
		...
		if(bin.timing_pos_num() == 0)
		{
		 sinogram[bin.view_num()][bin.tangential_pos_num()] +=
                non_ToF_sinogram[bin.view_num()][bin.tangential_pos_num()]*0.144;
		}

		if(bin.timing_pos_num() == 1)
		{
		 sinogram[bin.view_num()][bin.tangential_pos_num()] +=
                non_ToF_sinogram[bin.view_num()][bin.tangential_pos_num()]*0.133;
		}
		...
		if(bin.timing_pos_num() == 2)
		{
                ...
                sinogram[bin.view_num()][bin.tangential_pos_num()] +=
                non_ToF_sinogram[bin.view_num()][bin.tangential_pos_num()]*0.105;
                }

		 if(bin.timing_pos_num() == 3)
                {
		 sinogram[bin.view_num()][bin.tangential_pos_num()] +=
                non_ToF_sinogram[bin.view_num()][bin.tangential_pos_num()]*0.075;
                }

                if(bin.timing_pos_num() == 4)
                {
		 sinogram[bin.view_num()][bin.tangential_pos_num()] +=
                non_ToF_sinogram[bin.view_num()][bin.tangential_pos_num()]*0.047;
                }
                ...
                /*(*segment_ptr)[bin.axial_pos_num()]*/
                sinogram[bin.view_num()][bin.tangential_pos_num()] +=
                non_ToF_sinogram[bin.view_num()][bin.tangential_pos_num()]*0.026;
                }
		 ...
		 sinogram[bin.view_num()][bin.tangential_pos_num()] +=
                ...
                {
		 sinogram[bin.view_num()][bin.tangential_pos_num()] +=
                non_ToF_sinogram[bin.view_num()][bin.tangential_pos_num()]*0.006;
                }
                ...
                /*(*segment_ptr)[bin.axial_pos_num()]*/
                sinogram[bin.view_num()][bin.tangential_pos_num()] +=
                non_ToF_sinogram[bin.view_num()][bin.tangential_pos_num()]*0.004;
                }
		 ...
		 sinogram[bin.view_num()][bin.tangential_pos_num()] +=
                ...
                /*(*segment_ptr)[bin.axial_pos_num()]*/
                sinogram[bin.view_num()][bin.tangential_pos_num()] +=
                non_ToF_sinogram[bin.view_num()][bin.tangential_pos_num()]*0.003;
                }
		...
		if(bin.timing_pos_num() == 12)
		 ...
		 sinogram[bin.view_num()][bin.tangential_pos_num()] +=
                ...
                {
                 sinogram[bin.view_num()][bin.tangential_pos_num()] +=
                non_ToF_sinogram[bin.view_num()][bin.tangential_pos_num()]*0.132;
                }
                ...
                /*(*segment_ptr)[bin.axial_pos_num()]*/
                sinogram[bin.view_num()][bin.tangential_pos_num()] +=
                non_ToF_sinogram[bin.view_num()][bin.tangential_pos_num()]*0.104;
                }
                ...
                {
                 sinogram[bin.view_num()][bin.tangential_pos_num()] +=
                non_ToF_sinogram[bin.view_num()][bin.tangential_pos_num()]*0.049;
                }
                ...
                {
                 sinogram[bin.view_num()][bin.tangential_pos_num()] +=
                non_ToF_sinogram[bin.view_num()][bin.tangential_pos_num()]*0.014;
                }

                if(bin.timing_pos_num() == -7)
                {
                 sinogram[bin.view_num()][bin.tangential_pos_num()] +=
                non_ToF_sinogram[bin.view_num()][bin.tangential_pos_num()]*0.007;
                }
