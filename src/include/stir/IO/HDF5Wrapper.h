...
public:
    ...
    Succeeded initialise_geo_scaling_factors(const std::string& path);
...
#if 0
    Succeeded get_from_1d_dataset(const std::array<unsigned long long int, 1>& offset,
                                               const std::array<unsigned long long int, 1>& count,
                                               const std::array<unsigned long long int, 1>& stride,
                                               const std::array<unsigned long long int, 1>& block,
                                               Array<1, unsigned float> &output);
#endif
